...
void startMenu() {  // Функция вызывается только в сетапе, при первом запуске.
...
/////////////////////////////////////////////////////////////////
    ...
    while (true) {
        ...
        // --- ВЫХОД ИЗ МЕНЮ ---
        // В оригинале выход — при удержании кнопки энкодера.
        if (btnOk.hold()) {
...
void encbtn() {
    ...
    // Дополнительно: обработка быстрых нажатий (step)
    // Это обеспечивает непрерывное изменение при удержании кнопок
